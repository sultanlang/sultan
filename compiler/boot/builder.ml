...
let compile_sultanc () =
  ...
  let link_command = "ocamlfind ocamlc -o ../../sultanc -package Str -linkpkg id.cmo error.cmo ast.cmo types.cmo castle.cmo flags.cmo sparser.cmo slexer.cmo errorlog.cmo import.cmo semantics.cmo codegen.cmo hfile.cmo compile.cmo sbase.cmo driver.cmo main.cmo > /dev/null 2>&1" in
